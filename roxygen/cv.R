...
#' 
#' The Coefficient of Variation of an object with multiple iterations along the
...
#' \eqn{\frac{\sqrt{diag(\Sigma)}}{\Theta}}{sqrt(diag(sigma))/theta}, where
#' \eqn{\Sigma}{sigma} is the variance-covariance matrix of the
