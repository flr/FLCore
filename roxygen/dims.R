...
#' 
#' \code{dims} return a named list with information on the dimensions and
#' dimension names of a given object \code{obj}. The list returned could be
...
#' cohort in series} \item{unit}{Lengt of the third (\code{unit}) dimension}
#' \item{season}{Lengt of the fourth (\code{season}) dimension}
#' \item{area}{Lengt of the fifth (\code{area}) dimension} \item{iter}{Lengt of
#' the sixth (\code{iter}) dimension} } Values in the returned list are of
...
#' with the name of the first dimension on the input object. Use
