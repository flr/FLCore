...
Plot methods in the
[`lattice`](https://rdrr.io/pkg/lattice/man/Lattice.html) package are
available for an object of classes `FLQuant`, `FLQuants` or those
derived from `FLComp`.

See the help page in
[`lattice`](https://rdrr.io/pkg/lattice/man/Lattice.html) for a full
description of each plot method and all possible arguments.
