...
- wts.nyears:
  ...
  Number of years in calculation of mean weight-at-age and maturity for
  the extra year.

- fbar.nyears:

  Number of years in calculation of mean selectivity, natural mortality
  and fraction of F abnd M before spawning for the extra year.
