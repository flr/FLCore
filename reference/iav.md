...
object, is computed as \\\|x_y - x\_{y-1}) / x\_{y-1}\|\\. The resulting
object will be one year shorter than the input. The first year will be
missing as values are assigned to the final year of each pair.
