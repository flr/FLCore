...
{
  warning("read.FLIndex has been renamed as readFLIndex and will be deprecated", immediate. = TRUE)
  readFLIndex(...)
}
...
{
  warning("read.FLIndices has been renamed as readFLIndices and will be deprecated", immediate. = TRUE)
  readFLIndices(...)
} # }}}
