...
#'
#' @name FLIndexBiomass
#' @aliases FLIndexBiomass FLIndexBiomass,FLQuant-method FLIndexBiomass,missing-method
#' FLIndexBiomass-methods FLIndexBiomassBiomass FLQuant catch.n,FLIndexBiomass-method
